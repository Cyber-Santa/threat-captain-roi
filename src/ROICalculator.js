...
const ROICalculator = () => {
   const [inputs, setInputs] = useState({
       ...
       monthlyLeads: 15,
       averageDealSize: 15000, // This will be calculated
       closeRate: 15,
       churnRate: 10,
   ...
   const handleChange = (e) => {
       ...
       setInputs(prev => {
           ...
           // If revenue or customers changed, update average deal size
           if (name === 'annualRevenue' || name === 'currentCustomers') {
               if (newInputs.currentCustomers > 0) {
                   newInputs.averageDealSize = newInputs.annualRevenue / newInputs.currentCustomers;
               }
           }
           ...
           <div className="input-group">
               ...
               <div className="input-field">
                   ...
                   <input
                       ...
                       value={inputs.averageDealSize.toLocaleString()}
                       readOnly
